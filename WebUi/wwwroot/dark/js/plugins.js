...
!function (a) {
    ...
    function f(b) {
        ...
        function i(b, c) {
            ...
            var d = b.style, e = d.right, f = b.runtimeStyle, g = f && f.right;
            return g && (f.right = b.currentStyle.right), d.right = c, c = d.pixelLeft, d.right = e, g && (f.right = g), c
        }
    ...
    e.extend(g.prototype, b.prototype), g.prototype._create = function () {
        ...
        var a = j(this.element), b = this.layout.options, c = b.isOriginLeft, d = b.isOriginTop,
            e = a[c ? "right" : "left"], f = a[d ? "top" : "bottom"], g = this.layout.size,
            h = -1 != e.indexOf("%") ? parseFloat(e) / 100 * g.width : parseInt(e, 10),
            i = -1 != f.indexOf("%") ? parseFloat(f) / 100 * g.height : parseInt(f, 10);
        h = isNaN(h) ? 0 : h, i = isNaN(i) ? 0 : i, h -= c ? g.paddingLeft : g.paddingRight, i -= d ? g.paddingTop : g.paddingBottom, this.position.x = h, this.position.y = i
    }, g.prototype.layoutPosition = function () {
        var a = this.layout.size, b = this.layout.options, c = {}, d = b.isOriginLeft ? "paddingLeft" : "paddingRight",
            e = b.isOriginLeft ? "right" : "left", f = b.isOriginLeft ? "left" : "right", g = this.position.x + a[d];
    ...
    return g.namespace = "outlayer", g.Item = f, g.defaults = {
        ...
        var b = a.getBoundingClientRect(), c = this._boundingRect, e = d(a), f = {
            right: b.right - c.right - e.marginLeft,
            top: b.top - c.top - e.marginTop,
            left: c.left - b.left - e.marginRight,
    ...
    return d.prototype._resetLayout = function () {
        ...
        var c = b(a), d = this._getElementOffset(a), e = this.options.isOriginLeft ? d.right : d.left,
...
(function (a) {
    a.fn.niceSelect = function (d) {
        ...
        function c(g) {
            g.after(a("<div></div>").addClass("nice-select").addClass(g.attr("class") || "").addClass(g.attr("disabled") ? "disabled" : "").addClass(g.attr("multiple") ? "has-multiple" : "").attr("tabindex", g.attr("disabled") ? null : "0").html(g.attr("multiple") ? '<span class="multiple-options"></span><div class="nice-select-search-box"><input type="text" class="nice-select-search" placeholder="جستجو"/></div><ul class="list"></ul>' : '<span class="current"></span><div class="nice-select-search-box"><input type="text" class="nice-select-search" placeholder="جستجو"/></div><ul class="list"></ul>'));
            var h = g.next();
            var e = g.find("option");
            if (g.attr("multiple")) {

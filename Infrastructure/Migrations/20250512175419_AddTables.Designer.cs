...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250512175419_AddTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ApartmentEntity", b =>
                {
                    ...
                    b.Property<int>("PropertyDeedType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.FacilityEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("ApartmentEntityId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("28beecf9-964f-453c-9a93-5152819c612e"),
                            Title = "آسانسور"
                        },
                        new
                        {
                            Id = new Guid("3733a995-9e24-4cea-bfc5-9955b4906d48"),
                            Title = "پارکینگ"
                        },
                        new
                        {
                            Id = new Guid("1cea4b91-c9a2-4a4b-be10-a4479c3e4948"),
                            Title = "انیاری"
                        },
                        new
                        {
                            Id = new Guid("e15b7548-9b74-401d-a27f-61f37d8f5289"),
                            Title = "بالکن"
                        },
                        new
                        {
                            Id = new Guid("eb7c375f-8d7d-42c0-b93a-e867ef8b8866"),
                            Title = "نوساز"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.FacilityEntity", b =>
                {
                    b.HasOne("Domain.Entities.ApartmentEntity", null)
                        .WithMany("Facilities")

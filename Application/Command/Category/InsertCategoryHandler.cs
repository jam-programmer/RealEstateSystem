    ...
    IRequestHandler<InsertCategoryCommand, BaseResult>
{
    ...
    public InsertCategoryHandler(ILogger<InsertCategoryHandler> logger,
                                 IRepository<CategoryEntity, Guid> categoryRepository)
    {
        _categoryRepository = categoryRepository;
        _logger = logger;
    }
    public async Task<BaseResult> Handle(InsertCategoryCommand request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            await _categoryRepository.InsertAsync(categoryEntity, cancellationToken);
